    ...
    <main className="space-y-10">
      <section className="card flex flex-col md:flex-row gap-6 items-center">
        <div className="flex-1 space-y-4">
          <p className="text-sm uppercase tracking-wide text-primary font-semibold">AutoEnroll.ie</p>
          ...
          <div className="flex gap-4">
            <Link href="/dashboard" className="px-4 py-2 rounded-md bg-primary text-white font-semibold shadow">
              Launch app
            </Link>
            <Link href="#pricing" className="px-4 py-2 rounded-md border border-primary text-primary font-semibold">
              Pricing
            </Link>
          </div>
        </div>
      ...
      <section id="pricing" className="grid md:grid-cols-3 gap-4">
        {[{ name: 'Starter', price: '€19/mo', uploads: '20 uploads' }, { name: 'Growth', price: '€49/mo', uploads: '200 uploads' }, { name: 'Enterprise', price: 'Custom', uploads: 'Advanced controls' }].map((tier) => (
          <div key={tier.name} className="card space-y-2">
            ...
            <Link href="/dashboard" className="inline-block px-4 py-2 rounded bg-primary text-white">
              Get started
            </Link>
          </div>
        ))}
