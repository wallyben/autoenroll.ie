...
- `docs`: Research, legal, architecture, billing, analytics, and testing docs.
- `LEGAL`: Customer-facing privacy, terms, DPA, and security overviews.
...
## Legal & GDPR
See `docs/legal-constraints.md`, `docs/gdpr-model.md`, and `LEGAL/` documents for processor duties, retention rules, and security controls.

## Roadmap
- Add persistent Postgres storage for organisations and subscriptions.
- Implement webhook handling for Stripe events and upload quotas.
- Expand validation coverage (PRSI cross-checks, duplicate detection across periods).
- Build full audit UI with download history and retention controls.
